...
//               <div className="text-xs text-gray-500 uppercase tracking-wider">Happy Players</div>
//             </div>
//             <div className="w-px bg-gray-700" />
//             <div className="text-center">
...
//           <div>
//             <h2 className="text-3xl font-black text-white">Featured <span className="text-yellow-400">Products</span></h2>
//             <p className="text-gray-500 text-sm mt-1">Top picks for champions</p>
//           </div>
...
//                     <div className="absolute top-3 right-3 bg-green-400/90 text-gray-950 text-xs font-bold px-2 py-0.5 rounded-full">In Stock</div>
//                   </div>
//                   <div className="p-4">
//                     <h2 className="text-sm font-bold text-white truncate group-hover:text-yellow-400 transition-colors">{item.name}</h2>
//                     <p className="text-gray-500 text-xs mt-1 line-clamp-2">{item.description}</p>
//                     <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-800">
//                       <span className="text-xl font-black text-yellow-400">₹{item.price}</span>
//                       <span className="text-xs text-gray-600 line-through">₹{item.price + 500}</span>
//                     </div>
...
import React, { useEffect, useState } from "react";
import { Link } from "react-router-dom";
import API from "./Ap"; // JWT API instance
